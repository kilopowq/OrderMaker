...
public class DesertsFragment extends AbstractTabFragment {

    private static final int LAYOUT = R.layout.fragment_dishes;
    private List<MenuDTO> data;
    private MenuListAdapter adapter;

    public static DesertsFragment getInstance(Context context, List<MenuDTO> data){
        ...
        fragment.setTitle(context.getString(R.string.tab_deserts));
